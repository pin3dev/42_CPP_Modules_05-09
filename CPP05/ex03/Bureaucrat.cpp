...
/*   Updated: 2024/03/18 10:22:48 by pin3dev          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * Destructor
 * @brief Deletes the Bureaucrat object, either by an explicit call (delete Bureaucrat) 
...
/**
 * @brief Try to sign a form with the bureaucrat, 
 * 		if the form was signed, displays a message to the standard output,
 * 		if not, catch the exception from the beSigned method from the Form class.
 * @param[out] f a reference to the Form object to be signed by the bureaucrat.
 * @warning this function calls the beSigned method from the Form class
*/
void Bureaucrat::signForm(AForm &f)
{
	std::cout << YELLOW "> [Bureaucrat] " << this->getName() 
	<< " is trying to sign the form " << f.getName() 
	<<  "..." RESET << std::endl;
	...
	{
		std::cout << RED "[Bureaucrat] " << this->getName() << " couldn't sign " 
...
/**
 * @brief Try to execute a form with the bureaucrat, 
 * 		if the form was signed and the grade of bureaucrat is high enough than
 *		displays a message to the standard output
 * 		if not, catch the exception from the execute method from the AForm derived concrete class
 * @param[out] f a reference to the AForm object to be signed by the bureaucrat.
 * @warning this function calls the execute method from the AForm class derived concrete class
*/
void	Bureaucrat::executeForm(AForm const &form)
{
	std::cout << YELLOW "> [Bureaucrat] " 
	<< this->getName() << " is trying to execute the form " 
	...
	{
		std::cout << RED "[Bureaucrat] " << this->getName() << " couldnt execute form " 
