...
/*   Updated: 2024/03/18 11:07:42 by pin3dev          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#include "AForm.hpp" //to Form class
#include "mColors.hpp" //to define the colors MACROS and ENUM

class AForm; //Forward declaration because of the circular dependency
...
class Bureaucrat
{
	...
	public :
        ...
        */		
		 ...
		 * @note The exception classes are declared internally to the Bureaucrat class
		 * 		and are used only by the Bureaucrat class, so they are private.
        */
		class	GradeTooHighException : public std::exception
		{
			public :
				 ...
				 * NOTE 1 - The const throw() is a specification that indicates that the function does not throw exceptions.
				 * NOTE 2 - The virtual is a specification that indicates that the function can be overrided by a derived class.
				*/
